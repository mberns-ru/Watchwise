...
defaults = {
    ...
    "zip_loaded":      False,
    "pending_query":   "",
    "auto_run":        False,   # triggers run when example is clicked
}
...
# Reserve loader slot inside right column before any conditional rendering
...
if st.session_state.imdb_summary:
    with st.expander("🎞️ IMDB metadata summary"):
